...
case 3:
#line 28 "calc.y"
	{ yystack.l_mark[-2].symptr->value = yystack.l_mark[0].dval; }
break;
case 4:
#line 29 "calc.y"
...
#line 37 "calc.y"
	{
        if (yystack.l_mark[0].dval == 0.0) /* need to check for div by 0 */
...
case 13:
#line 46 "calc.y"
	{ yyval.dval = yystack.l_mark[0].symptr->value; }
break;
#line 561 "y.tab.c"
    }
    yystack.s_mark -= yym;
