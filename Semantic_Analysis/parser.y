...
scopedVarDecl : STATIC typeSpec varDeclList ';'     {$$ = $3; setType($3,$2,true);}//$$->varKind = LocalStatic;/* DRBC Note: Be careful! And setType.*/}
...
compoundStmt : '{' localDecls stmtList '}'         {$$ = newStmtNode(CompoundK,$1,$2,$3);}   //localDecls用来变量定义，stmtList表达式语句和循环判断语句
             ;
...
call       : ID '(' args ')' {$$ = newExpNode(CallK,$1,$3);/* $$->isArray = true; */}
           ;
